...
const MsgSetWithdrawAddress = Root.iris2.MsgSetWithdrawAddress;
const MsgWithdrawDelegatorReward = Root.iris2.MsgWithdrawDelegatorReward;
const MsgWithdrawValidatorCommission = Root.iris2.MsgWithdrawValidatorCommission;

MsgSetWithdrawAddress.prototype.type = Config.iris2.tx.setWithdrawAddress.prefix;
MsgSetWithdrawAddress.prototype.GetSignBytes = function () {
    let msg = {
        delegator_address: BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress),
        withdraw_address: BECH32.encode(Config.iris2.bech32.accAddr, this.WithdrawAddress),
    };
...
MsgSetWithdrawAddress.prototype.toJSON = function () {
    let delegator_addr = BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress);
    let withdraw_addr = BECH32.encode(Config.iris2.bech32.accAddr, this.WithdrawAddress);
    return {
        DelegatorAddress: delegator_addr,
        WithdrawAddress: withdraw_addr,
    }
...
MsgWithdrawDelegatorReward.prototype.type = Config.iris2.tx.withdrawDelegatorReward.prefix;
MsgWithdrawDelegatorReward.prototype.GetSignBytes = function () {
    let msg = {
        delegator_address: BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress),
        validator_address: BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorAddress),
    };
    let sortMsg = Utils.sortObjectKeys(msg);
    return Amino.MarshalJSON(this.type, sortMsg)
};
...
MsgWithdrawDelegatorReward.prototype.toJSON = function () {
    let delegatorAddr = BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress);
    let validatorAddress = BECH32.encode(Config.iris2.bech32.accAddr, this.ValidatorAddress);
    return {
...
MsgWithdrawDelegatorReward.prototype.GetDisplayContent = function () {
    let delegatorAddress = BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress);
    let validatorAddress = BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorAddress);
...
MsgWithdrawValidatorCommission.prototype.type = Config.iris2.tx.withdrawValidatorCommission.prefix;
