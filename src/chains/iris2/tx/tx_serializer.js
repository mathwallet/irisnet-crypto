...
class TxSerializer {
    ...
    static encode(object) {
        ...
        let fee = object.fee;
        let StdFee = root.iris2.StdFee;
        let feeMsg = StdFee.create(fee);

        let StdSignature = root.iris2.StdSignature;
        let signature;
        ...
        let txPreBuf = Buffer.from(amino.GetRegisterInfo(config.iris2.tx.stdTx.prefix).prefix);
