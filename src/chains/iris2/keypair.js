...
class Iris2Keypair {
    ...
    static getPrivateKeyFromSecret(mnemonicS) {
        ...
        let derivedPriv = Hd.DerivePrivateKeyForPath(master.secret, master.chainCode, Config.iris2.bip39Path);
        return derivedPriv;
    }
    ...
    static create(language) {
        ...
        pubKey = Amino.MarshalBinary(Config.iris2.amino.pubKey, pubKey);
    ...
    static isValidAddress(address) {
        let prefix = Config.iris2.bech32.accAddr;
