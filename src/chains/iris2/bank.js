...
const MsgSend = Root.iris2.MsgSend;
MsgSend.prototype.GetSignBytes = function () {

    let msg = {
        "from_address": BECH32.encode(Config.iris2.bech32.accAddr, this.FromAddress),
        "to_address": BECH32.encode(Config.iris2.bech32.accAddr, this.ToAddress),
        "amount": this.Amount
    };
...
MsgSend.prototype.type = Config.iris2.tx.transfer.prefix;
MsgSend.prototype.GetDisplayContent = function () {
    let from = BECH32.encode(Config.iris2.bech32.accAddr, this.FromAddress);
    let to = BECH32.encode(Config.iris2.bech32.accAddr, this.ToAddress);
    return {
