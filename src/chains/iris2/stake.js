...
const MsgDelegate = Root.iris2.MsgDelegate;
const MsgUndelegate = Root.iris2.MsgUndelegate;
const MsgBeginRedelegate = Root.iris2.MsgBeginRedelegate;

MsgDelegate.prototype.type = Config.iris2.tx.delegate.prefix;
...
MsgUndelegate.prototype.type = Config.iris2.tx.undelegate.prefix;
...
MsgBeginRedelegate.prototype.type = Config.iris2.tx.beginRedelegate.prefix;
MsgBeginRedelegate.prototype.GetSignBytes = function () {
    let msg = {
        delegator_address: BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress),
        validator_src_address: BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorSrcAddress),
        validator_dst_address: BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorDstAddress),
        amount: this.Amount
    };
    let sortMsg = Utils.sortObjectKeys(msg);
    return Amino.MarshalJSON(this.type, sortMsg)
...
MsgBeginRedelegate.prototype.GetDisplayContent = function () {
    let delegatorAddress = BECH32.encode(Config.iris2.bech32.accAddr, this.DelegatorAddress);
    let validatorSrcAddress = BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorSrcAddress);
    let validatorDstAddress = BECH32.encode(Config.iris2.bech32.valAddr, this.ValidatorDstAddress);
